# Generated by Django 3.1.6 on 2021-02-27 15:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_serviceProvider', models.BooleanField(default=False, verbose_name='serviceProvider status')),
        ...
        migrations.CreateModel(
            name='Consumer',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='service.user')),
            ],
        ),
        migrations.CreateModel(
